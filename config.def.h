...
static const char *colors[][3]      = {
	...
	[SchemeStatus]  	= { col_ice,   col_navy,  col_navy }, // Statusbar right
	[SchemeTagsSel]  	= { col_blue,  col_navy,  col_navy }, // Tagbar left selected
    	[SchemeTagsNorm]  	= { col_ice,   col_navy,  col_orange }, // Tagbar left unselected
    	[SchemeInfoSel]  	= { col_ice,   col_navy,  col_navy }, // infobar middle selected
    	[SchemeInfoNorm]  	= { col_ice,   col_navy,  col_navy }, // infobar middle unselected
};
